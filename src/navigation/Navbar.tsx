  ...
  return (
    ...
    <nav className="fixed top-0 2xl:left-[10%] left-0 bg-zinc-950 border-b border-neutral-800 z-50 w-[100%] 2xl:w-[80%] ] ">
      <div className="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <ul
          className={`absolute top-16 left-0 w-full bg-zinc-950 origin-top transform transition-all duration-300 ease-in-out md:static md:flex md:items-center md:space-x-6 md:bg-transparent md:top-0 ${
            isMenuOpen
